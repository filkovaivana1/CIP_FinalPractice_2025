...
public class DataInitializer {
    ...
    @Bean
    CommandLineRunner dataInitialize(BookstoreService bookstoreService, BookService bookService, BookRepository bookRepository, BookstoreRepository bookstoreRepository){
        return args -> {
            ...
            //Bookstore existingBookstore = bookstoreRepository.findById(Long.parseLong("55")).get();
